...
var loginCartNote = "<div class='login-note'>Please note this login is for Song Saa Private Island gifting platform only.<div>";
...
var addcompleteText = '<div class="card-footer-right"><span>&copy; 2022 Song Saa Private Island</span></div>'
    ...
    $(function() {
      ...
      setInterval(function() {
        ...
        $('.footer a:contains("Contact Us")').each(function () {
          var string_email = 'reservationsmgr@songsaa.com';
        ...
        $('.social-links img[alt="instagram"]:not(.modified)').addClass('modified').attr('src', 'https://static.techsembly.com/RGdeyZ3YnywXf5cHFfJgrZsp');
        $('.social-links img[alt="fb"]:not(.modified)').addClass('modified').attr('src', 'https://static.techsembly.com/jGaGHLJdvHZmi2wNCdFKa5WX');
